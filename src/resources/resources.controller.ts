...
export class ResourcesController {
    ...
    @Patch(':id')
    @UseGuards(AuthGuard())
    async update(@Param('id', MongoIdPipe) id: string, @Body() updateResource: UpdateResourceDTO):Promise<GetResourceDTO>{
    ...
    @Put(':id')
    @UseGuards(AuthGuard())
    async updatePut(@Param('id', MongoIdPipe) id: string, @Body() updateResource: UpdateResourceDTO):Promise<GetResourceDTO>{
        const resource = await this.resourcesService.updateById(id, updateResource);
